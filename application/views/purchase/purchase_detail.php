<div style="float:right;">
	<a  class="btn btn-info" href="<?php echo base_url();?>cpurchase/create_purchase_pdf/{purchase_id}">Download PDF</a>
...
<table border="0" width="97%" style="margin-top:20px;margin-bottom:15px;border-collapse:collapse;">
	<tbody>
		<tr>
			<td> 
			&nbsp;&nbsp;&nbsp; We are very much pleased to forward the below products.Please deliver these products as soon as possible as per our requirements.
			</td> 
		</tr>
	</tbody>
</table>
